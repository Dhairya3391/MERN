...
const students = [
    { id: 1, name: 'Dhairya', enrollmentNumber: '24010101602', mobile: '9664847885', department: 'CSE', spi: 8 },
    { id: 2, name: 'Harpal', enrollmentNumber: '24010101642', mobile: '3462765382', department: 'CSE', spi: 9.5 },
];
...
const readStudentDetails = (filename) => {
    ...
    const students = content.split('\n').map(data => {
        const [id, name, enrollmentNumber, mobile, department, spi] = data.split(',');
        return { id, name, enrollmentNumber, mobile, department, spi: parseFloat(spi) };
    });
